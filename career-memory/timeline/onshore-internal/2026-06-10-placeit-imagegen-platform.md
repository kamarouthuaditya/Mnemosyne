...
business_impact: "Replaced Placid, the paid render SaaS that cost ~$39/mo (~₹4.5k/mo, ~₹54k/yr), with a self-hosted engine on existing Vercel + Supabase at ~$0 marginal cost. Also removed the per-render pricing and vendor lock-in from the daily content pipeline's critical path."
---
## What I built
